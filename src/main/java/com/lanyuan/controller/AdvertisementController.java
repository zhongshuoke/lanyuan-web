...
public class AdvertisementController extends BaseController{
	...
	public Object saveOrUpdatePic(HttpServletRequest request,String Id) throws Exception{
		 Integer userID = 0;
	        ...
	        int width = 0; // 原始图片宽
	        int height = 0; // 原始图片高
	        String adPicWidth = PropertiesUtils.findPropertiesKey("adPicWidth");
	        String adPicHeight = PropertiesUtils.findPropertiesKey("adPicHeight");
	        try {
	            ...
	            if (bufimg != null) {
	                ...
	                if ( !StringUtils.equals(adPicWidth, String.valueOf(width))|| !StringUtils.equals(adPicHeight, String.valueOf(height))) {
	                	Map<String, Object> map = new HashMap<String, Object>();
	                	map.put("successs", false);
	                	map.put("errorMsg", "您上传的推荐文章图片失败,失败原因是:尺寸不正确，正确的应该是"+adPicWidth+" x "+adPicHeight);
	                	return map;
	                }
	            }
	            is.close();
