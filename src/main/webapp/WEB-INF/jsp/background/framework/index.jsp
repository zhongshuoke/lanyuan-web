...
<script type="text/javascript">
	...
	$(function() {
		...
		$(".l_flow-btn").toggle(function() {
			$(".l_container .container").slideUp(0);
			$(".l_container .leafSet").slideDown(0);
			/////////////////////////////////////////////
			//$(".l_body").css("background","none repeat scroll 0 0 #FAFAFA");
		}, function() {
			$(".l_container .container").slideDown(0);
			$(".l_container .leafSet").slideUp(0);
		});
...
<body onresize="divsize();">
	...
	<div class="l_header" id="l_header">
		<span id="workbench" style="visibility: hidden;" class="l_flow-btn"
			style="z-index: 0">主页</span>
	</div>
				...
				<div class="cl_body"
					...
					<div id="divHeght">
						...
						<div style="float: right; width: 83%;" id="framecenter">
							<div class="box-content" tabid="home" title="众说客主页">
								<br>
								<h2>众说客是一家专做草根自媒体的APP</h2>
							</div>
						</div>
					</div>
				</div>
	...
	<div class="bom" id="bom">
		<a href="login.html" target="_self"><h3>
				<button class="yellow">注销用户</button>
			</h3></a>
	</div>
</body>
