    ...
    <div class="box png">
		...
		<div class="input">
			...
			action="${pageContext.servletContext.contextPath }/submitlogin.html">
				...
				<div class="pwd">
					<label>密　码</label><input type="password" class="text" id="password" placeholder="密码" name="password" tabindex="2" onkeyup="enterHandler(event)">
					<input id="loginBtn" type="button" class="submit" tabindex="3" value="登录" onclick="checkUserForm();">
					<div class="check"></div>
				</div>
				<div class="tip"></div>
				</form>
