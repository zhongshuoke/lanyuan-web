...
<div class="divdialog">
	...
	<form name="form" id="form" action="${ctx}/background/wxrecommarticle/updateabstract.html" method="post">
		<table style="width: 285px; height: 200px;">
			<tbody>
				<tr>
					<td class="l_right">id：</td>
					<td class="l_left">
					<input id='id' name="id" type="hidden" value="${wxRecommendToday.id}">
					${wxRecommendToday.id}</td>
				</tr>
				<tr>
					<td class="l_right">摘要：</td>
					<td class="l_left">
					<div class="lanyuan_input">
					<input id='str_abstract'
						name="str_abstract" type="text" class="isNum" value="${wxRecommendToday.str_abstract}">
						</div>
					</td>
				</tr>
				<tr>
