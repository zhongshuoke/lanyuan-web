...
<script type="text/javascript">
    ...
    $(function() {
        $("#editWxView").click("click", function() {
   					$.ajax({
					    ...
					    url: rootPath + '/background/wxarticle/queryhtml.html', //要访问的后台地址
    ...
    $(function() {
        $("#saveWxView").click("click", function() {
   					$.ajax({
					    type: "post", //使用get方法访问后台
					    dataType: "json", //json格式的数据
					    url: rootPath + '/background/wxarticle/savehtml.html', //要访问的后台地址
	...
	$("#preWxView").click("click", function() {//绑定预览按扭
		dialog = parent.$.ligerDialog.open({
			width : 1000,
			height : 1100,
			url : rootPath + '/background/wxarticle/addUI.html?articleId='+$("#articleid").val(),
			title : "预览文章",
