...
<div class="divdialog">
	...
	<form name="form" id="form" action="${ctx}/background/wxaccount/update.html" method="post">
		<table style="width: 285px; height: 200px;">
			<tbody>
				<tr>
					<td class="l_right">公众号：</td>
					<td class="l_left">
					<input id='id' name="id" type="hidden" value="${wxAccount.id}">
					${wxAccount.wxAccountNo}</td>
				</tr>
				<tr>
					<td class="l_right">公众号名：</td>
					<td class="l_left">
					<div class="lanyuan_input">
					<input id='wxAccountName'
						name="wxAccountName" type="text" class="isNum" value="">
						</div>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<input id='description'
						name="description" type="text" class="checkdesc" value="${wxAccount.description}">
						</div>
					</td>
				</tr>
				<tr>
